...
export function EditPersonaModal({ stakeholder, open, onOpenChange }: EditPersonaModalProps) {
    ...
    useEffect(() => {
        if (stakeholder) {
            setFormData({
                ...
                grade: stakeholder.grade,
                seniority: stakeholder.seniority,
                proactivity: stakeholder.proactivity,
                productivity: stakeholder.productivity,
                skills: stakeholder.skills,
                general_description: stakeholder.general_description,
                can_delegate: stakeholder.can_delegate,
                organization_id: stakeholder.organization_id || '',
                circle: stakeholder.circle || 'same_org',
            });
        }
    }, [stakeholder]);
            ...
            <DialogContent className="max-w-2xl max-h-[90vh] overflow-y-auto">
                <DialogHeader>
                    <div className="flex items-center justify-between">
                        <DialogTitle>Edit Persona: {stakeholder?.name}</DialogTitle>
                        <Button
                            type="button"
                            variant="outline"
                            size="sm"
                            ...
                            <div className="space-y-3">
                                <div className="flex items-start gap-2 text-primary">
                                    ...
                                    <p className="text-[11px] font-medium leading-relaxed">
                                        Paste the LinkedIn profile text to auto-populate fields for this persona.
                                    </p>
                                </div>
                                <Textarea
                ...
                <form onSubmit={handleSubmit} className="space-y-6 pt-4">
                    ...
                    <div className="space-y-2">
                        ...
                        <Textarea
                            ...
                            onChange={handleChange}
                            placeholder="Detailed context for the AI coach..."
                    ...
                    <div className="flex items-center space-x-2 bg-secondary/20 p-4 rounded-xl border border-border/50">
                        ...
                        />
                        <label htmlFor="can_delegate" className="text-sm font-bold text-foreground cursor-pointer">
                            Authorized for Task Delegation
                        </label>
                        <p className="text-[10px] text-muted-foreground ml-auto italic">If checked, AI will suggest offloading tasks to this persona.</p>
                    </div>

                    <DialogFooter>
                        <Button type="button" variant="ghost" onClick={() => onOpenChange(false)}>Cancel</Button>
                        <Button type="submit" disabled={updateMutation.isPending} className="font-bold px-8">
